...
const tiers = [
  ...
  { name: "Silver",   fontSize: "1.3rem", sponsors: [
      ...
      { name: "RISE Research", logo: "/sponsors/RISE_White.PNG", url: "https://riseglobaleducation.com/" },
    ], emptySlots: 1 },
                ...
                {tier.sponsors.map((s) => (
                  <a key={s.name} href={s.url} target="_blank" rel="noopener noreferrer"
                    ...
                    <img src={s.logo} alt={s.name}
                         style={{ height: "28px", width: s.name === "AoPS" || s.name === "Figma" || s.name === "ScraperCity" || s.name === "PCBWay" || s.name === "RISE Research" ? "auto" : "28px", maxWidth: s.name === "ScraperCity" ? "90px" : s.name === "PCBWay" ? "70px" : "84px", objectFit: "contain", flexShrink: 0, transform: s.name === "Figma" ? "scale(1.22)" : s.name === "RISE Research" ? "scale(1.35)" : undefined }} />
